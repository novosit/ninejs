...
(function (factory) {
	...
	return (function() {
		...
		Modernizr.addTest('getusermedia', !!Modernizr.prefixed('getUserMedia', navigator)); // Test for `srcdoc` attribute in iframes.
		//
		...
		Modernizr.addTest('quotamanagement', function() {
			var temporaryStorage = Modernizr.prefixed('TemporaryStorage', window),
				persistentStorage = Modernizr.prefixed('PersistentStorage', window);
